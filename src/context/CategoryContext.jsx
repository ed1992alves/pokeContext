...
export const CategoryProvider = ({children}) => {
    ...
    const getProductsIdsByCategoryIdAndPage = (categoryId) => {
        ...
        return getProductsIdsByCategoryId(categoryId).slice(
            /*Start*/    (getActualPageByCategoryId(categoryId) - 1) * numberOfProductsByPage,
            /*End*/    ((getActualPageByCategoryId(categoryId) - 1) * numberOfProductsByPage) + numberOfProductsByPage
        )
    }
